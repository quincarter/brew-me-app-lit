...
export class CalculatorPage extends SignalWatcher(LitElement) {
  ...
  private _onRecipeSelect = (
    ...
    if (selectedType === "Aeropress") {
      ...
      loadCleverDripperRecipeIntoCalculator(
        event.detail as ICleverDripperRecipe,
      );
      ...
      <div class="screen">
        ...
        <div class="content">
          ...
          <brew-button
            ...
            ><brew-icon .svg="${CALCULATE_ICON_SVG}" size="18"></brew-icon>
            Quick calculator</brew-button
          >
  ...
  render(): HTMLTemplateResult {
    ...
    const recipeSource = isQuickCalculator
      ? null
      ...
      <div class="screen">
        ...
        <div class="content">
          ...
          ${brewSteps
            ? html`
                ...
                <brew-steps-card
                  ...
                  .diffAgainst="${resolvedSteps
                    ? resolvedSteps.diffAgainst
                    : null}"
          ...
          <brew-button
            ...
            ><brew-icon .svg="${TIMER_ICON_SVG}" size="22"></brew-icon> Start
            guided timer</brew-button
          >
          <brew-button
            variant="filled"
            full-width
            ...
            ><brew-icon .svg="${SAVED_ICON_SVG}" size="18"></brew-icon>
            Save</brew-button
          >
          ${this._shareStatusText
