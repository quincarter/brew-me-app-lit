...
export const routes: IRouteConfig[] = [
  ...
  {
    name: "Brew Type Settings",
    path: "/more/settings/brew-types",
    tagName: "brew-type-settings-page",
    directory: "brew-type-settings-page",
    fileName: "brew-type-settings-page",
  },
  {
    name: "Display Settings",
    path: "/more/settings/display",
    tagName: "display-settings-page",
    directory: "display-settings-page",
    fileName: "display-settings-page",
  },
  {
    name: "Data Settings",
    path: "/more/settings/data",
    tagName: "data-settings-page",
    directory: "data-settings-page",
    fileName: "data-settings-page",
  },
  {
    name: "General Settings",
    path: "/more/settings/general",
    tagName: "general-settings-page",
    directory: "general-settings-page",
    fileName: "general-settings-page",
  },
  {
    name: "Cloud Sync",
