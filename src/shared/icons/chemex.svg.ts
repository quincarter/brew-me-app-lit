...
export const CHEMEX_ICON = svg`<svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
          ...
          <path d="M9 14 L15 14 L15.3 20.5 L8.7 20.5 Z"></path>
          <path d="M8.7 20.5c0 .9 1.1 1.6 3.3 1.6s3.3-.7 3.3-1.6"></path>
          <circle cx="16.8" cy="11.6" r="0.9"></circle>
          <path d="M17 12.5c1 .2 1.7 1 1.5 2s-1.3 1.5-2.1 1c.5.6.3 1.4-.3 1.7"></path>
        </svg>`;
